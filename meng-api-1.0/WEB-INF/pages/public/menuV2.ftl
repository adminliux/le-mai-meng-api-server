<#macro menuV2 title>
    ...
    <script>
        ...
        $body.addClass("fixed-sidebar full-height-layout gray-bg");
    </script>
    <div id="wrapper">
        <!--左侧导航开始-->
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                        ...
                        <div class="dropdown profile-element">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    ...
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">商会</strong>
                                    </span>
									</span>
                            </a>
                        </div>
                        <div class="logo-element">商会
                        </div>
                    </li>
                    ...
                    <li>
                        <a class="J_menuItem" href="${pathPage}/config/update">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">全局配置</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.Advertisement">
                            <i class="fa fa-home"></i>
                    ...
                    <li>
                        <a class="J_menuItem"
                           href="${pathPage}/index/list?type=com.chamber.entity.CooperativeEnterprise">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">合作伙伴链接</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.CofCNews">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">商会新闻</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.AttractInvestment">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">招商引资</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.CofCMagpieBridge">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">商会鹊桥</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.CofCMember">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">商会会员</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.ContactUs">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">联系我们</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.GuideAdmission">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">入会指南</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.LawWripr">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">甘浙会</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.CofCNotice">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">商会公告</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/index/list?type=com.chamber.entity.MemberInformation">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">会员资讯</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem"
                           href="${pathPage}/index/list?type=com.rpframework.module.common.bottom.entity.AdminUser">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">后台账号</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${pathPage}/resource/manage/role/jurisdiction">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">资源文件</span>
                        </a>
                    </li>
                ...
                <#--<li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="${pathPage}/index/list?type=com.daolezuche.entity.UserCapitalRecord">资金流水</a>
                        </li>
                    </ul>
                </li>-->
                    <li class="line dk"></li>
                ...
                <#--</li>-->
                <#--<li>-->
                <#--<a class="J_menuItem" href="css_animation.html"><i class="fa fa-magic"></i> <span-->
                <#--class="nav-label">CSS动画</span></a>-->
                <#--</li>-->
                <#--<li>-->
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${pathViewHAdmin}/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${pathViewHAdmin}/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="${pathPage}/config/update" frameborder="0"
                        data-id="${pathPage}/config/update" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
    ...
    <!-- 全局js -->
    <script src="${pathViewHAdmin}/js/jquery.min.js?v=2.1.4"></script>
    ...
    <script src="${pathViewHAdmin}/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="${pathViewHAdmin}/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="${pathViewHAdmin}/js/plugins/layer/layer.min.js"></script>
    ...
    <!-- 自定义js -->
    <script src="${pathViewHAdmin}/js/hAdmin.js?v=4.1.0"></script>
    <script type="text/javascript" src="${pathViewHAdmin}/js/index.js"></script>


    <!-- 第三方插件 -->
    <script src="${pathViewHAdmin}/js/plugins/pace/pace.min.js"></script>
    </@frame.frameV2>
</#macro>