                    ...
                    <div class="ibox-content">
                        <div class="top-wrapper">
                         <div class="conditions-wrapper">
                             <select name="" id="Sort"  class="SeletDeal">
                                 <option value="0">正序</option>
                                 <option value="1">倒序</option>
                             </select>
                             <select name="" id="Zs"  class="SeletDeal">
...
//    关闭弹窗
        ...
        function findList(pageNum) {
            ...
            var Zs = $('#Zs').val();
//
            var p = $.extend({pageNum: pageNum}, {pageSize: pageSize}, {zs: Zs}, {sort: Sort});
            Project.ajax("/admin/user/capital/find/car/detail/page", p, null, null).ajaxOK(function (data) {
